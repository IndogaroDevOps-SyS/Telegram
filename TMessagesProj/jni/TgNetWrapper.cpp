...
static const char *NativeByteBufferClassPathName = "id/indogaro/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "id/indogaro/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lid/indogaro/tgnet/RequestTimeDelegate;)J", (void *) checkProxy},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("id/indogaro/tgnet/RequestTimeDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("id/indogaro/tgnet/ConnectionsManager"));
