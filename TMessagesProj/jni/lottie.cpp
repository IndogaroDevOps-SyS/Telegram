...
JNIEXPORT jlong JNICALL Java_id_indogaro_ui_Components_RLottieNative_nCreate(
...
JNIEXPORT jlong JNICALL Java_id_indogaro_ui_Components_RLottieNative_nCreateWithJson(
...
JNIEXPORT void JNICALL Java_id_indogaro_ui_Components_RLottieNative_nDestroy(JNIEnv *, jclass, jlong ptr) {
    tlottie_drop(reinterpret_cast<TLottieInstance *>(ptr));
}

JNIEXPORT jint JNICALL Java_id_indogaro_ui_Components_RLottieNative_nGetFrame(
