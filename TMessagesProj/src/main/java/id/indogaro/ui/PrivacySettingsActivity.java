...
import id.indogaro.ui.bots.BotBiometrySettings;
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == webSessionsRow) {
                        ...
                        textCell.setText(getString("IndogaroPassport", R.string.IndogaroPassport), true);
                    } else if (position == deleteAccountRow) {
                        ...
                        switch (SharedConfig.mapPreviewType) {
                            case 0:
                                value = getString("MapPreviewProviderIndogaro", R.string.MapPreviewProviderIndogaro);
                                break;
                            case 1:
