...
import static id.indogaro.tgnet.tl.TL_stories.Boost.NO_USER_ID;
...
public class TableCell extends FrameLayout {
    ...
    public void setData(TLRPC.TL_payments_checkedGiftCode giftCode, Utilities.Callback<TLObject> onObjectClicked) {
        ...
        giftTextView.setText(LocaleController.formatString("BoostingIndogaroPremiumFor", R.string.BoostingIndogaroPremiumFor, monthsStr));
