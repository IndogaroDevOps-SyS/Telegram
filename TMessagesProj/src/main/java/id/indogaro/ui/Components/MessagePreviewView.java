...
import id.indogaro.messenger.MessagePreviewParams;
...
import id.indogaro.ui.Cells.IMessageCell;
    ...
    private class Page extends FrameLayout {
        ...
        public Page(Context context, int tab) {
                ...
                sendersNameButton.setOnClickListener(view -> {
                    if (!canHideSenderName) {
                        BulletinFactory.of(MessagePreviewView.this, resourcesProvider)
                            .createSimpleBulletin(R.raw.star_premium_2, replaceSingleTag("Subscribe to **Indogaro Premium** to forward formatted messages without the sender’s name.", () -> {
                                dismiss(false);
            ...
            if (textSelectionOverlay != null) {
                ...
                addView(textSelectionOverlay, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.TOP | Gravity.LEFT, 0, id.indogaro.ui.ActionBar.ActionBar.getCurrentActionBarHeight() / AndroidUtilities.density, 0, 0));
            }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            ((MarginLayoutParams) chatListView.getLayoutParams()).topMargin = id.indogaro.ui.ActionBar.ActionBar.getCurrentActionBarHeight();
            if (isLandscapeMode) {
