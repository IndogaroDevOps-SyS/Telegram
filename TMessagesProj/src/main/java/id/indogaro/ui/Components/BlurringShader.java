...
public class BlurringShader {
    ...
    public void draw(float[] oesMatrix, int texture, int textureWidth, int textureHeight) {
        ...
        id.indogaro.ui.Components.Paint.Shader.SetColorUniform(p.gradientTopHandle, gradientTop);
        id.indogaro.ui.Components.Paint.Shader.SetColorUniform(p.gradientBottomHandle, gradientBottom);
