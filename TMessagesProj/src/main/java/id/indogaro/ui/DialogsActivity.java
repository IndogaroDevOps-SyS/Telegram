...
import static id.indogaro.ui.Components.AlertsCreator.createClearOrDeleteDialogsAlert;
...
import id.indogaro.messenger.FilesMigrationService;
...
import id.indogaro.messenger.VideoEditedInfo;
...
import id.indogaro.messenger.XiaomiUtilities;
import id.indogaro.messenger.browser.Browser;
import id.indogaro.messenger.utils.FBool;
import id.indogaro.messenger.utils.GradientProtectionDrawable;
import id.indogaro.messenger.utils.SearchTextWatcher;
...
import id.indogaro.ui.ActionBar.MenuDrawable;
...
import id.indogaro.ui.Adapters.DialogsAdapter;
import id.indogaro.ui.Adapters.DialogsSearchAdapter;
import id.indogaro.ui.Adapters.FiltersView;
import id.indogaro.ui.Cells.ActiveGiftAuctionsHintCell;
import id.indogaro.ui.Cells.AnimatedStatusView;
import id.indogaro.ui.Cells.ArchiveHintInnerCell;
import id.indogaro.ui.Cells.DialogCell;
import id.indogaro.ui.Cells.DialogsEmptyCell;
import id.indogaro.ui.Cells.DialogsHintCell;
import id.indogaro.ui.Cells.GraySectionCell;
import id.indogaro.ui.Cells.HashtagSearchCell;
import id.indogaro.ui.Cells.HeaderCell;
import id.indogaro.ui.Cells.HintDialogCell;
import id.indogaro.ui.Cells.LoadingCell;
import id.indogaro.ui.Cells.ProfileSearchCell;
import id.indogaro.ui.Cells.RequestPeerRequirementsCell;
...
import id.indogaro.ui.Cells.UnconfirmedAuthHintCell;
...
import id.indogaro.ui.Components.ArchiveHelp;
import id.indogaro.ui.Components.AvatarDrawable;
import id.indogaro.ui.Components.BackupImageView;
import id.indogaro.ui.Components.BlurredRecyclerView;
import id.indogaro.ui.Components.ColoredImageSpan;
import id.indogaro.ui.Components.DialogsActivityStatusLayout;
import id.indogaro.ui.Components.DialogsActivityTopBubblesFadeView;
import id.indogaro.ui.Components.DialogsActivityTopPanelLayout;
import id.indogaro.ui.Components.FragmentFloatingButton;
import id.indogaro.ui.Components.FragmentSearchField;
import id.indogaro.ui.Components.IconBackgroundColors;
import id.indogaro.ui.Components.ImageUpdater;
import id.indogaro.ui.Components.PermissionRequest;
import id.indogaro.ui.Components.UItem;
import id.indogaro.ui.Components.blur3.BlurredBackgroundDrawableViewFactory;
import id.indogaro.ui.Components.blur3.BlurredBackgroundWithFadeDrawable;
import id.indogaro.ui.Components.blur3.DownscaleScrollableNoiseSuppressor;
import id.indogaro.ui.Components.blur3.RenderNodeWithHash;
import id.indogaro.ui.Components.blur3.capture.IBlur3Capture;
import id.indogaro.ui.Components.blur3.capture.IBlur3Hash;
...
import id.indogaro.ui.Components.blur3.source.BlurredBackgroundSource;
...
import id.indogaro.ui.Components.chat.ChatInputViewsContainer;
import id.indogaro.ui.Components.chat.ViewPositionWatcher;
import id.indogaro.ui.Components.chat.layouts.ChatActivityFadeView;
import id.indogaro.ui.Components.inset.WindowInsetsStateHolder;
...
import id.indogaro.ui.Stories.StealthModeAlert;
...
import id.indogaro.ui.Components.ChatActivityEnterView;
...
import id.indogaro.ui.Components.DialogsItemAnimator;
import id.indogaro.ui.Components.FilterTabsView;
import id.indogaro.ui.Components.FiltersListBottomSheet;
...
import id.indogaro.ui.Components.FloatingDebug.FloatingDebugProvider;
import id.indogaro.ui.Components.FolderBottomSheet;
import id.indogaro.ui.Components.FolderDrawable;
import id.indogaro.ui.Components.ForegroundColorSpanThemable;
import id.indogaro.ui.Components.Forum.ForumUtilities;
import id.indogaro.ui.Components.FragmentContextView;
...
import id.indogaro.ui.Components.NumberTextView;
import id.indogaro.ui.Components.PacmanAnimation;
...
import id.indogaro.ui.Components.ProxyDrawable;
import id.indogaro.ui.Components.PullForegroundDrawable;
import id.indogaro.ui.Components.RLottieDrawable;
import id.indogaro.ui.Components.Reactions.ReactionsLayoutInBubble;
import id.indogaro.ui.Components.RecyclerAnimationScrollHelper;
import id.indogaro.ui.Components.RecyclerItemsEnterAnimator;
import id.indogaro.ui.Components.RecyclerListView;
import id.indogaro.ui.Components.SearchViewPager;
import id.indogaro.ui.Components.ShareTopView;
import id.indogaro.ui.Components.SharedMediaLayout;
import id.indogaro.ui.Components.SimpleThemeDescription;
import id.indogaro.ui.Components.SizeNotifierFrameLayout;
import id.indogaro.ui.Components.StickersAlert;
import id.indogaro.ui.Components.SwipeGestureSettingsView;
import id.indogaro.ui.Components.UndoView;
import id.indogaro.ui.Components.ViewPagerFixed;
import id.indogaro.ui.Stories.DialogStoriesCell;
import id.indogaro.ui.Stories.StoriesController;
import id.indogaro.ui.Stories.StoriesListPlaceProvider;
import id.indogaro.ui.Stories.UserListPoller;
import id.indogaro.ui.Stories.recorder.HintView2;
import id.indogaro.ui.Stories.recorder.StoryRecorder;
import id.indogaro.ui.community.CommunityChatType;
import id.indogaro.ui.community.CommunityEditActivity;
import id.indogaro.ui.community.CommunityPendingRequestsActivity;
import id.indogaro.ui.community.CommunityUtils;
import id.indogaro.ui.community.cells.CommunityRequestsCell;
    ...
    public View createView(final Context context) {
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                logoDrawable = context.getResources().getDrawable(R.drawable.indogaro_logo_2).mutate();
                logoDrawable.setBounds(0, dp(2), logoDrawable.getIntrinsicWidth(), dp(2) + logoDrawable.getIntrinsicHeight());
                logoDrawable.setColorFilter(getThemedColor(Theme.key_indogaro_color_dialogsLogo), PorterDuff.Mode.MULTIPLY);
        ...
        if (hasMainTabs) {
            ...
            actionBar.setTitleColor(getThemedColor(Theme.key_indogaro_color_dialogsLogo));
        }
...
//            }
        ...
        if (folderId == 0) {
            ...
            arrayList.add(new ThemeDescription(actionBar, ThemeDescription.FLAG_AB_TITLECOLOR, null, null, new Drawable[]{Theme.dialogs_holidayDrawable}, null, !hasMainTabs ? Theme.key_actionBarDefaultTitle : Theme.key_indogaro_color_dialogsLogo));
            ...
            arrayList.add(new ThemeDescription(actionBar, ThemeDescription.FLAG_AB_TITLECOLOR, null, null, new Drawable[]{Theme.dialogs_holidayDrawable}, null, !hasMainTabs ? Theme.key_actionBarDefaultArchivedTitle : Theme.key_indogaro_color_dialogsLogo));
        ...
        for (int a = 0; a < 3; a++) {
            ...
            arrayList.add(new ThemeDescription(list, 0, new Class[]{DialogCell.class}, null, new Drawable[]{Theme.dialogs_pinnedDrawable2Accent}, null, Theme.key_indogaro_color_text));
            ...
            arrayList.add(new ThemeDescription(list, 0, new Class[]{DialogCell.class}, Theme.dialogs_timePaintBoldAccent, null, null, Theme.key_indogaro_color_text));
        ...
        if (viewPages != null) {
            for (int a = 0; a < viewPages.length; a++) {
                ...
                arrayList.add(new ThemeDescription(viewPages[a].listView, 0, new Class[]{UserCell.class}, new String[]{"statusOnlineColor"}, null, null, cellDelegate, Theme.key_indogaro_color_text));
