...
import id.indogaro.tgnet.tl.TL_communities;
...
import id.indogaro.ui.Cells.SlideIntChooseView;
import id.indogaro.ui.Cells.TextCell;
import id.indogaro.ui.Cells.TextCheckCell;
import id.indogaro.ui.Cells.TextCheckCell2;
...
import id.indogaro.ui.Components.GigagroupConvertAlert;
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == signMessagesRow) {
                ...
                if (isExpandableSendMediaRow(position)) {
                    ...
                    if (info != null && !info.antispam && getParticipantsCount() < getMessagesController().indogaroAntispamGroupSizeMin) {
                        BulletinFactory.of(this).createSimpleBulletin(R.raw.msg_antispam, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelAntiSpamForbidden", getMessagesController().indogaroAntispamGroupSizeMin))).show();
                        ...
                        textCell.getCheckBox().setIcon(ChatObject.canUserDoAdminAction(currentChat, ChatObject.ACTION_DELETE_MESSAGES) && (info == null || info.antispam || getParticipantsCount() >= getMessagesController().indogaroAntispamGroupSizeMin) ? 0 : R.drawable.permission_locked);
