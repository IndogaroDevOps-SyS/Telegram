...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString(R.string.OptimizingIndogaro));
        ...
        description1.setText(LocaleController.getString(R.string.OptimizingIndogaroDescription1));
        ...
        description2.setText(LocaleController.getString(R.string.OptimizingIndogaroDescription2));
