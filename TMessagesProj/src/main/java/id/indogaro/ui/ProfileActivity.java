...
import static id.indogaro.messenger.AndroidUtilities.dpf2;
import static id.indogaro.messenger.AndroidUtilities.ilerp;
import static id.indogaro.messenger.AndroidUtilities.lerp;
import static id.indogaro.messenger.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
import static id.indogaro.messenger.LocaleController.formatPluralString;
import static id.indogaro.messenger.LocaleController.formatPluralStringComma;
import static id.indogaro.messenger.LocaleController.formatString;
import static id.indogaro.messenger.LocaleController.getString;
import static id.indogaro.ui.Stars.StarGiftSheet.replaceUnderstood;
import static id.indogaro.ui.Stars.StarsIntroActivity.formatStarsAmountShort;
import static id.indogaro.ui.bots.AffiliateProgramFragment.percents;
...
import id.indogaro.ui.Components.ScrimOptions;
import id.indogaro.ui.Components.blur3.drawable.color.impl.BlurredBackgroundProviderImpl;
import id.indogaro.ui.Components.blur3.source.BlurredBackgroundSourceBitmap;
import id.indogaro.ui.Components.blur3.utils.Blur3Utils;
import id.indogaro.ui.recyclerview.LinearSmoothScrollerCustom;
import androidx.recyclerview.widget.RecyclerView;
import androidx.viewpager.widget.PagerAdapter;
import androidx.viewpager.widget.ViewPager;

import id.indogaro.PhoneFormat.PhoneFormat;
import id.indogaro.messenger.AccountInstance;
import id.indogaro.messenger.AndroidUtilities;
import id.indogaro.messenger.ApplicationLoader;
import id.indogaro.messenger.AuthTokensHelper;
import id.indogaro.messenger.BillingController;
import id.indogaro.messenger.BirthdayController;
import id.indogaro.messenger.BuildVars;
import id.indogaro.messenger.ChatObject;
import id.indogaro.messenger.ChatThemeController;
import id.indogaro.messenger.ContactsController;
import id.indogaro.messenger.DialogObject;
import id.indogaro.messenger.DocumentObject;
import id.indogaro.messenger.Emoji;
import id.indogaro.messenger.FileLoader;
import id.indogaro.messenger.FileLog;
import id.indogaro.messenger.FlagSecureReason;
import id.indogaro.messenger.ImageLoader;
import id.indogaro.messenger.ImageLocation;
import id.indogaro.messenger.ImageReceiver;
import id.indogaro.messenger.LanguageDetector;
...
import id.indogaro.messenger.MediaDataController;
import id.indogaro.messenger.MessageObject;
import id.indogaro.messenger.MessagesController;
import id.indogaro.messenger.MessagesStorage;
...
import id.indogaro.messenger.SharedConfig;
import id.indogaro.messenger.SvgHelper;
import id.indogaro.messenger.UserConfig;
import id.indogaro.messenger.UserObject;
import id.indogaro.messenger.Utilities;
import id.indogaro.messenger.browser.Browser;
import id.indogaro.tgnet.ConnectionsManager;
import id.indogaro.tgnet.SerializedData;
import id.indogaro.tgnet.TLObject;
import id.indogaro.tgnet.TLRPC;
import id.indogaro.tgnet.tl.TL_account;
import id.indogaro.tgnet.tl.TL_bots;
import id.indogaro.tgnet.tl.TL_fragment;
import id.indogaro.tgnet.tl.TL_iv;
import id.indogaro.tgnet.tl.TL_stars;
import id.indogaro.tgnet.tl.TL_stories;
import id.indogaro.ui.ActionBar.ActionBar;
import id.indogaro.ui.ActionBar.ActionBarMenu;
import id.indogaro.ui.ActionBar.ActionBarMenuItem;
import id.indogaro.ui.ActionBar.ActionBarMenuSubItem;
import id.indogaro.ui.ActionBar.ActionBarPopupWindow;
import id.indogaro.ui.ActionBar.AlertDialog;
import id.indogaro.ui.ActionBar.BackDrawable;
import id.indogaro.ui.ActionBar.BaseFragment;
import id.indogaro.ui.ActionBar.BottomSheet;
import id.indogaro.ui.ActionBar.INavigationLayout;
import id.indogaro.ui.ActionBar.OKLCH;
import id.indogaro.ui.ActionBar.SimpleTextView;
import id.indogaro.ui.ActionBar.Theme;
import id.indogaro.ui.ActionBar.ThemeDescription;
import id.indogaro.ui.Business.OpeningHoursActivity;
import id.indogaro.ui.Business.ProfileHoursCell;
import id.indogaro.ui.Business.ProfileLocationCell;
import id.indogaro.ui.Cells.AboutLinkCell;
import id.indogaro.ui.Cells.AnimatedStatusView;
import id.indogaro.ui.Cells.CheckBoxCell;
import id.indogaro.ui.community.CommunityArrowDrawable;
import id.indogaro.ui.community.cells.CommunityLinkView;
import id.indogaro.ui.Cells.DividerCell;
import id.indogaro.ui.Cells.GraySectionCell;
import id.indogaro.ui.Cells.HeaderCell;
import id.indogaro.ui.Cells.NotificationsCheckCell;
import id.indogaro.ui.Cells.ProfileChannelCell;
import id.indogaro.ui.Cells.SettingsSearchCell;
import id.indogaro.ui.Cells.SettingsSuggestionCell;
import id.indogaro.ui.Cells.ShadowSectionCell;
import id.indogaro.ui.Cells.TextCell;
import id.indogaro.ui.Cells.TextCheckCell;
import id.indogaro.ui.Cells.TextDetailCell;
import id.indogaro.ui.Cells.TextInfoPrivacyCell;
import id.indogaro.ui.Cells.UserCell;
import id.indogaro.ui.Components.AlertsCreator;
import id.indogaro.ui.Components.AnimatedColor;
import id.indogaro.ui.Components.AnimatedEmojiDrawable;
import id.indogaro.ui.Components.AnimatedEmojiSpan;
import id.indogaro.ui.Components.AnimatedFileDrawable;
import id.indogaro.ui.Components.AnimatedFloat;
import id.indogaro.ui.Components.AnimatedTextView;
import id.indogaro.ui.Components.AnimationProperties;
import id.indogaro.ui.Components.AudioPlayerAlert;
import id.indogaro.ui.Components.AutoDeletePopupWrapper;
import id.indogaro.ui.Components.AvatarDrawable;
import id.indogaro.ui.Components.BackButtonMenu;
import id.indogaro.ui.Components.BackupImageView;
import id.indogaro.ui.Components.Bulletin;
import id.indogaro.ui.Components.BulletinFactory;
import id.indogaro.ui.Components.ButtonBounce;
import id.indogaro.ui.Components.CanvasButton;
import id.indogaro.ui.Components.ChatActivityInterface;
import id.indogaro.ui.Components.ChatAvatarContainer;
import id.indogaro.ui.Components.ChatNotificationsPopupWrapper;
import id.indogaro.ui.Components.ColoredImageSpan;
import id.indogaro.ui.Components.CombinedDrawable;
import id.indogaro.ui.Components.CrossfadeDrawable;
import id.indogaro.ui.Components.CubicBezierInterpolator;
import id.indogaro.ui.Components.DotDividerSpan;
import id.indogaro.ui.Components.EmojiPacksAlert;
import id.indogaro.ui.Components.EmptyStubSpan;
import id.indogaro.ui.Components.FloatingDebug.FloatingDebugController;
import id.indogaro.ui.Components.Forum.ForumUtilities;
import id.indogaro.ui.Components.HintView;
import id.indogaro.ui.Components.HintsController;
import id.indogaro.ui.Components.IdenticonDrawable;
import id.indogaro.ui.Components.ImageUpdater;
import id.indogaro.ui.Components.InstantCameraView;
import id.indogaro.ui.Components.ItemOptions;
import id.indogaro.ui.Components.JoinGroupAlert;
import id.indogaro.ui.Components.LayoutHelper;
import id.indogaro.ui.Components.LinkSpanDrawable;
import id.indogaro.ui.Components.MediaActivity;
import id.indogaro.ui.Components.MessagePrivateSeenView;
import id.indogaro.ui.Components.ProfileActionsView;
import id.indogaro.ui.Components.ProfileGalleryBlurView;
import id.indogaro.ui.Components.Paint.PersistColorPalette;
import id.indogaro.ui.Components.Premium.LimitPreviewView;
import id.indogaro.ui.Components.Premium.PremiumFeatureBottomSheet;
import id.indogaro.ui.Components.Premium.PremiumGradient;
import id.indogaro.ui.Components.Premium.PremiumPreviewBottomSheet;
import id.indogaro.ui.Components.Premium.ProfilePremiumCell;
import id.indogaro.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import id.indogaro.ui.Components.ProfileGalleryView;
import id.indogaro.ui.Components.ProfileGooeyView;
import id.indogaro.ui.Components.ProfileMusicView;
import id.indogaro.ui.Components.RLottieDrawable;
import id.indogaro.ui.Components.RLottieImageView;
import id.indogaro.ui.Components.RadialProgressView;
import id.indogaro.ui.Components.Reactions.ReactionsLayoutInBubble;
import id.indogaro.ui.Components.RecyclerListView;
import id.indogaro.ui.Components.ScaleStateListAnimator;
import id.indogaro.ui.Components.ScamDrawable;
import id.indogaro.ui.Components.ShareAlert;
import id.indogaro.ui.Components.SharedMediaLayout;
import id.indogaro.ui.Components.SizeNotifierFrameLayout;
import id.indogaro.ui.Components.StarRatingView;
import id.indogaro.ui.Components.StickerEmptyView;
import id.indogaro.ui.Components.TagEditCell;
import id.indogaro.ui.Components.TimerDrawable;
import id.indogaro.ui.Components.TranslateAlert2;
import id.indogaro.ui.Components.TypefaceSpan;
import id.indogaro.ui.Components.UItem;
import id.indogaro.ui.Components.UndoView;
import id.indogaro.ui.Components.VectorAvatarThumbDrawable;
import id.indogaro.ui.Components.blur3.BlurredBackgroundDrawableViewFactory;
import id.indogaro.ui.Components.blur3.DownscaleScrollableNoiseSuppressor;
import id.indogaro.ui.Components.blur3.ViewGroupPartRenderer;
import id.indogaro.ui.Components.blur3.capture.IBlur3Capture;
...
import id.indogaro.ui.Components.chat.ViewPositionWatcher;
import id.indogaro.ui.Components.voip.VoIPHelper;
import id.indogaro.ui.Gifts.GiftSheet;
import id.indogaro.ui.Stars.BotStarsActivity;
import id.indogaro.ui.Stars.BotStarsController;
import id.indogaro.ui.Stars.ProfileGiftsView;
import id.indogaro.ui.Stars.StarGiftPatterns;
import id.indogaro.ui.Stars.StarGiftSheet;
import id.indogaro.ui.Stars.StarsController;
import id.indogaro.ui.Stars.StarsIntroActivity;
import id.indogaro.ui.Stories.ProfileStoriesView;
import id.indogaro.ui.Stories.StoriesController;
import id.indogaro.ui.Stories.StoriesListPlaceProvider;
import id.indogaro.ui.Stories.StoryViewer;
import id.indogaro.ui.Stories.recorder.ButtonWithCounterView;
import id.indogaro.ui.Stories.recorder.DualCameraView;
import id.indogaro.ui.Stories.recorder.HintView2;
import id.indogaro.ui.Stories.recorder.StoryRecorder;
import id.indogaro.ui.TON.TONIntroActivity;
import id.indogaro.ui.bots.AffiliateProgramFragment;
import id.indogaro.ui.bots.BotBiometry;
import id.indogaro.ui.bots.BotDownloads;
import id.indogaro.ui.bots.BotLocation;
import id.indogaro.ui.bots.BotWebViewAttachedSheet;
import id.indogaro.ui.bots.ChannelAffiliateProgramsFragment;
import id.indogaro.ui.bots.SetupEmojiStatusSheet;
import id.indogaro.ui.community.CommunitySheet;
...
//        sharedMediaLayout.setBackgroundColor(getThemedColor(Theme.key_windowBackgroundWhite));
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == affiliateRow) {
                ...
                Browser.openUrl(getParentActivity(), LocaleController.getString(R.string.IndogaroFaqUrl));
        ...
        if (position == usernameRow || position == setUsernameRow) {
            ...
            if (position == phoneRow) {
                if (userInfo != null && userInfo.phone_calls_available) {
                    o.add(R.drawable.msg_calls, getString(R.string.CallViaIndogaro), () -> {
                    ...
                    if (userInfo.video_calls_available) {
                        o.add(R.drawable.msg_videocall, getString(R.string.VideoCallViaIndogaro), () -> {
                            if (getParentActivity() == null) return;
            ...
            switch (holder.getItemViewType()) {
                ...
                case VIEW_TYPE_TEXT:
                    ...
                    if (position == settingsTimerRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString(R.string.IndogaroFAQ), R.drawable.msg2_help, true);
                    } else if (position == policyRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString(R.string.IndogaroPremium), new AnimatedEmojiDrawable.WrapSizeDrawable(PremiumGradient.getInstance().premiumStarMenuDrawable, dp(24), dp(24)), true);
                        textCell.setImageLeft(23);
                    } else if (position == starsRow) {
                        StarsController c = StarsController.getInstance(currentAccount);
                        long balance = c.getBalance().amount;
                        textCell.setTextAndValueAndIcon(LocaleController.getString(R.string.MenuIndogaroStars), c.balanceAvailable() && balance > 0 ? StarsIntroActivity.formatStarsAmount(c.getBalance(), 0.85f, ' ') : "", new AnimatedEmojiDrawable.WrapSizeDrawable(PremiumGradient.getInstance().goldenStarMenuDrawable, dp(24), dp(24)), true);
                        textCell.setImageLeft(23);
                    } else if (position == tonRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString(R.string.IndogaroBusiness), R.drawable.menu_shop, true);
                        textCell.setImageLeft(23);
                    } else if (position == premiumGiftingRow) {
...
//                    new SearchResult(504, getString(R.string.AddPhoto), 0, f::onWriteButtonClick),
                    ...
                    isPremiumFeatureAvailable(currentAccount, PremiumPreviewFragment.PREMIUM_FEATURE_APPLICATION_ICONS) ? new SearchResult(812, getString(R.string.PremiumPreviewAppIcon), getString(R.string.IndogaroPremium), R.drawable.msg_settings_premium, () -> f.showDialog(new PremiumFeatureBottomSheet(f, PremiumPreviewFragment.PREMIUM_FEATURE_APPLICATION_ICONS, false).setForceAbout())) : null,
                    isPremiumFeatureAvailable(currentAccount, PremiumPreviewFragment.PREMIUM_FEATURE_EMOJI_STATUS) ? new SearchResult(813, getString(R.string.PremiumPreviewEmojiStatus), getString(R.string.IndogaroPremium), R.drawable.msg_settings_premium, () -> f.showDialog(new PremiumFeatureBottomSheet(f, PremiumPreviewFragment.PREMIUM_FEATURE_EMOJI_STATUS, false).setForceAbout())) : null,
                    ...
                    new SearchResult(403, getString(R.string.IndogaroFAQ), getString(R.string.SettingsHelp), R.drawable.msg2_help, () -> Browser.openUrl(f.getParentActivity(), getString(R.string.IndogaroFaqUrl))).withLink("tg://settings/faq"),
        ...
        public void loadFaqWebPage() {
            ...
            req2.url = LocaleController.getString(R.string.IndogaroFaqUrl);
            req2.hash = 0;
    ...
    private boolean editRow(View view, int position) {
        ...
        if (position == bizHoursRow) {
            ...
            itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
                presentFragment(new id.indogaro.ui.Business.LocationActivity());
            });
