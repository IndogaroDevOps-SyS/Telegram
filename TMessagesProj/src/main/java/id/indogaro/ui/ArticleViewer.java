...
import static id.indogaro.messenger.MessageObject.POSITION_FLAG_BOTTOM;
import static id.indogaro.messenger.MessageObject.POSITION_FLAG_LEFT;
import static id.indogaro.messenger.MessageObject.POSITION_FLAG_RIGHT;
import static id.indogaro.messenger.MessageObject.POSITION_FLAG_TOP;
...
import id.indogaro.messenger.CodeHighlighting;
import id.indogaro.messenger.DownloadController;
import id.indogaro.messenger.Emoji;
import id.indogaro.messenger.FileLoader;
import id.indogaro.messenger.FileLog;
import id.indogaro.messenger.FileStreamLoadOperation;
...
import id.indogaro.ui.ActionBar.BottomSheetTabDialog;
...
import id.indogaro.ui.Components.AnchorSpan;
import id.indogaro.ui.Components.AnimatedArrowDrawable;
...
import id.indogaro.ui.Components.CheckBoxBase;
import id.indogaro.ui.Components.CombinedDrawable;
import id.indogaro.ui.Components.ContextProgressView;
...
import id.indogaro.ui.Components.MediaActionDrawable;
import id.indogaro.ui.Components.RadialProgress2;
import id.indogaro.ui.Components.RadioButton;
import id.indogaro.ui.Components.RecyclerListView;
import id.indogaro.ui.Components.SeekBar;
import id.indogaro.ui.Components.SeekBarView;
import id.indogaro.ui.Components.ShareAlert;
import id.indogaro.ui.Components.SizeNotifierFrameLayout;
import id.indogaro.ui.Components.SmoothScroller;
import id.indogaro.ui.Components.StaticLayoutEx;
import id.indogaro.ui.Components.TableLayout;
import id.indogaro.ui.Components.TextPaintImageReceiverSpan;
import id.indogaro.ui.Components.TextPaintMarkSpan;
import id.indogaro.ui.Components.TextPaintSpan;
import id.indogaro.ui.Components.TextPaintUrlSpan;
import id.indogaro.ui.Components.TextPaintWebpageUrlSpan;
...
import id.indogaro.ui.Components.VideoPlayer;
import id.indogaro.ui.Components.WebPlayerView;
import id.indogaro.ui.Components.spoilers.SpoilerEffect;
...
import id.indogaro.ui.Stories.recorder.KeyboardNotifier;
import id.indogaro.ui.web.AddressBarList;
import id.indogaro.ui.web.BookmarksFragment;
import id.indogaro.ui.web.BotWebViewContainer;
import id.indogaro.ui.bots.ChatAttachAlertBotWebViewLayout;
import id.indogaro.ui.web.BrowserHistory;
import id.indogaro.ui.web.HistoryFragment;
import id.indogaro.ui.web.SearchEngine;
import id.indogaro.ui.web.WebActionBar;
import id.indogaro.ui.web.WebBrowserSettings;
import id.indogaro.ui.web.WebInstantView;
...
import id.indogaro.ui.iv.Latex;
...
//                alert.show();
    ...
    public void openBookmark(String link) {
        ...
        if (Browser.isInternalUri(Uri.parse(link), null)) {
            ...
            if (pages[0] == null || pages[0].getWebView() == null) {
                Browser.openInIndogaroBrowser(parentActivity, link, null);
            } else {
    ...
    public void openHistoryEntry(BrowserHistory.Entry entry) {
        ...
        actionBar.showAddress(false, true);
        if (pages[0] == null || pages[0].getWebView() == null) {
            Browser.openInIndogaroBrowser(parentActivity, entry.url, null);
        } else {
            ...
            if (previousBlock != currentBlock) {
                ...
                try {
                    if (currentBlock.html != null) {
                        if (webView != null) {
                            webView.loadDataWithBaseURL("https://indogaro.org/embed", currentBlock.html, "text/html", "UTF-8", null);
                            webView.setVisibility(VISIBLE);
                        }
                        if (videoView != null) {
                            videoView.setVisibility(INVISIBLE);
