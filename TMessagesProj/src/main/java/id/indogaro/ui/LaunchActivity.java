...
import static id.indogaro.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import id.indogaro.messenger.AnimationNotificationsLocker;
import id.indogaro.messenger.ApplicationLoader;
import id.indogaro.messenger.AutoDeleteMediaTask;
import id.indogaro.messenger.BackupAgent;
import id.indogaro.messenger.BetaUpdate;
import id.indogaro.messenger.BirthdayController;
import id.indogaro.messenger.BotGuardHelper;
import id.indogaro.messenger.BotWebViewVibrationEffect;
import id.indogaro.messenger.BuildConfig;
import id.indogaro.messenger.BuildVars;
import id.indogaro.messenger.ChannelBoostsController;
import id.indogaro.messenger.ChatObject;
import id.indogaro.messenger.ContactsController;
import id.indogaro.messenger.ContactsLoadingObserver;
import id.indogaro.messenger.DialogObject;
import id.indogaro.messenger.FileLoader;
import id.indogaro.messenger.FileLog;
import id.indogaro.messenger.FingerprintController;
import id.indogaro.messenger.FlagSecureReason;
import id.indogaro.messenger.GenericProvider;
import id.indogaro.messenger.GiftAuctionController;
import id.indogaro.messenger.LiteMode;
import id.indogaro.messenger.LocaleController;
import id.indogaro.messenger.LocationController;
...
import id.indogaro.messenger.OpenAttachedMenuBotReceiver;
import id.indogaro.messenger.PushListenerController;
import id.indogaro.messenger.R;
import id.indogaro.messenger.SendMessagesHelper;
import id.indogaro.messenger.SharedConfig;
import id.indogaro.messenger.SharedPrefsHelper;
import id.indogaro.messenger.TopicsController;
...
import id.indogaro.messenger.pip.PipActivityController;
import id.indogaro.messenger.pip.activity.IPipActivity;
import id.indogaro.messenger.pip.activity.IPipActivityHandler;
import id.indogaro.messenger.pip.activity.IPipActivityListener;
import id.indogaro.messenger.utils.FrameMetricsOverlayView;
import id.indogaro.messenger.utils.LeakDetector;
import id.indogaro.messenger.utils.WindowVisibilityManager;
import id.indogaro.messenger.video.VideoAds;
import id.indogaro.messenger.voip.VideoCapturerDevice;
import id.indogaro.messenger.voip.VoIPGroupNotification;
import id.indogaro.messenger.voip.VoIPPendingCall;
import id.indogaro.messenger.voip.VoIPPreNotificationService;
import id.indogaro.messenger.voip.VoIPService;
import id.indogaro.tgnet.ConnectionsManager;
import id.indogaro.tgnet.TLObject;
import id.indogaro.tgnet.TLParseException;
import id.indogaro.tgnet.TLRPC;
import id.indogaro.tgnet.Vector;
import id.indogaro.tgnet.tl.TL_account;
import id.indogaro.tgnet.tl.TL_chatlists;
import id.indogaro.tgnet.tl.TL_forum;
import id.indogaro.tgnet.tl.TL_stars;
import id.indogaro.tgnet.tl.TL_stories;
import id.indogaro.ui.ActionBar.ActionBarLayout;
import id.indogaro.ui.ActionBar.AlertDialog;
import id.indogaro.ui.ActionBar.BaseFragment;
import id.indogaro.ui.ActionBar.BottomSheetTabs;
import id.indogaro.ui.ActionBar.BottomSheetTabsOverlay;
import id.indogaro.ui.ActionBar.DrawerLayoutContainer;
import id.indogaro.ui.ActionBar.INavigationLayout;
import id.indogaro.ui.ActionBar.Theme;
import id.indogaro.ui.Cells.ChatMessageCell;
import id.indogaro.ui.Cells.LanguageCell;
import id.indogaro.ui.Components.ActivityWindowEmptyBackgroundDrawable;
import id.indogaro.ui.Components.AlertsCreator;
import id.indogaro.ui.Components.AppIconBulletinLayout;
import id.indogaro.ui.Components.AttachBotIntroTopView;
import id.indogaro.ui.Components.AudioPlayerAlert;
import id.indogaro.ui.Components.BatteryDrawable;
import id.indogaro.ui.Components.BlockingUpdateView;
...
import id.indogaro.ui.Components.Easings;
import id.indogaro.ui.Components.EmbedBottomSheet;
import id.indogaro.ui.Components.EmojiPacksAlert;
import id.indogaro.ui.Components.FireworksOverlay;
import id.indogaro.ui.Components.FloatingDebug.FloatingDebugController;
import id.indogaro.ui.Components.FolderBottomSheet;
import id.indogaro.ui.Components.Forum.ForumUtilities;
import id.indogaro.ui.Components.GroupCallPip;
import id.indogaro.ui.Components.JoinGroupAlert;
import id.indogaro.ui.Components.LayoutHelper;
import id.indogaro.ui.Components.PasscodeView;
import id.indogaro.ui.Components.PasscodeViewDialog;
import id.indogaro.ui.Components.PhonebookShareAlert;
import id.indogaro.ui.Components.PipRoundVideoView;
import id.indogaro.ui.Components.PipVideoOverlay;
import id.indogaro.ui.Components.Premium.LimitReachedBottomSheet;
import id.indogaro.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import id.indogaro.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import id.indogaro.ui.Components.SearchTagsList;
import id.indogaro.ui.Components.ShareTopView;
import id.indogaro.ui.Components.SharingLocationsAlert;
import id.indogaro.ui.Components.SizeNotifierFrameLayout;
import id.indogaro.ui.Components.StickerSetBulletinLayout;
import id.indogaro.ui.Components.StickersAlert;
import id.indogaro.ui.Components.TermsOfServiceView;
import id.indogaro.ui.Components.TextStyleSpan;
import id.indogaro.ui.Components.ThemeEditorView;
import id.indogaro.ui.Components.UndoView;
import id.indogaro.ui.Components.inset.WindowAnimatedInsetsProvider;
import id.indogaro.ui.Components.poll.PollAttachedMediaPack;
import id.indogaro.ui.Components.spoilers.SpoilerEffect2;
import id.indogaro.ui.Components.voip.RTMPStreamPipOverlay;
import id.indogaro.ui.Components.voip.VoIPHelper;
import id.indogaro.ui.Gifts.GiftSheet;
import id.indogaro.ui.Stars.ISuperRipple;
import id.indogaro.ui.Gifts.AuctionJoinSheet;
import id.indogaro.ui.Stars.StarGiftPreviewSheet;
...
import id.indogaro.ui.Stars.SuperRipple;
...
import id.indogaro.ui.Stories.recorder.StoryEntry;
import id.indogaro.ui.Stories.recorder.StoryRecorder;
import id.indogaro.ui.Stories.LiveStoryPipOverlay;
import id.indogaro.ui.TON.TONIntroActivity;
import id.indogaro.ui.bots.BotWebViewAttachedSheet;
import id.indogaro.ui.bots.BotWebViewSheet;
import id.indogaro.ui.bots.WebViewRequestProps;
...
//                            BaseFragment sheetFragment = actionBarLayout1.getSheetFragment(false);
    ...
    @SuppressLint("Range")
    private boolean handleIntent(Intent intent, boolean isNew, boolean restore, boolean fromPassword, Browser.Progress progress, boolean rebuildFragments, boolean openedIndogaro) {
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                if (Intent.ACTION_SEND.equals(intent.getAction())) {
                ...
                } else if ("id.indogaro.messenger.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
                    ...
                    final LinkManager linkManager = new LinkManager(this, intentAccount[0], progress, openedIndogaro);
                        ...
                        if (scheme != null) {
                            switch (scheme) {
                                ...
                                case "https": {
                                    ...
                                    if (host.equals("indogaro.me") || host.equals("t.me") || host.equals("indogaro.dog") || isPrefix) {
                                        if (isPrefix) {
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                case "tg": {
                                    ...
                                    if (url.startsWith("tg:premium_offer") || url.startsWith("tg://premium_offer")) {
                                        ...
                                        url = url.replace("tg:resolve", "tg://indogaro.org").replace("tg://resolve", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        ...
                                        startApp = data.getQueryParameter("startapp");
                                        openProfile = data.getBooleanQueryParameter("profile", false);
                                        if ("indogaropassport".equals(username)) {
                                            username = null;
                                            auth = new HashMap<>();
                                        ...
                                        url = url.replace("tg:privatepost", "tg://indogaro.org").replace("tg://privatepost", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        messageId = Utilities.parseInt(data.getQueryParameter("post"));
                                        ...
                                        url = url.replace("tg:bg", "tg://indogaro.org").replace("tg://bg", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        wallPaper = new TLRPC.TL_wallPaper();
                                        wallPaper.settings = new TLRPC.TL_wallPaperSettings();
                                        ...
                                        url = url.replace("tg:join", "tg://indogaro.org").replace("tg://join", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://indogaro.org").replace("tg://addstickers", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        sticker = data.getQueryParameter("set");
                                    } else if (url.startsWith("tg:addemoji") || url.startsWith("tg://addemoji")) {
                                        url = url.replace("tg:addemoji", "tg://indogaro.org").replace("tg://addemoji", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://indogaro.org").replace("tg://msg", "tg://indogaro.org").replace("tg://share", "tg://indogaro.org").replace("tg:share", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                                        ...
                                        url = url.replace("tg:confirmphone", "tg://indogaro.org").replace("tg://confirmphone", "tg://indogaro.org");
                                        data = Uri.parse(url);

                                        phone = data.getQueryParameter("phone");
                                        phoneHash = data.getQueryParameter("hash");
                                    } else if (url.startsWith("tg:login") || url.startsWith("tg://login")) {
                                        url = url.replace("tg:login", "tg://indogaro.org").replace("tg://login", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:openmessage", "tg://indogaro.org").replace("tg://openmessage", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:passport", "tg://indogaro.org").replace("tg://passport", "tg://indogaro.org").replace("tg:secureid", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        auth = new HashMap<>();
                                        String scope = data.getQueryParameter("scope");
                                        if (!TextUtils.isEmpty(scope) && scope.startsWith("{") && scope.endsWith("}")) {
                                        ...
                                        url = url.replace("tg:setlanguage", "tg://indogaro.org").replace("tg://setlanguage", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        lang = data.getQueryParameter("lang");
                                    } else if (url.startsWith("tg:addtheme") || url.startsWith("tg://addtheme")) {
                                        url = url.replace("tg:addtheme", "tg://indogaro.org").replace("tg://addtheme", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:search", "tg://indogaro.org").replace("tg://search", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:addcontact", "tg://indogaro.org").replace("tg://addcontact", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:addlist", "tg://indogaro.org").replace("tg://addlist", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        folderSlug = data.getQueryParameter("slug");
                                    } else if (url.startsWith("tg:message") || url.startsWith("tg://message")) {
                                        url = url.replace("tg:message", "tg://indogaro.org").replace("tg://message", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        chatLinkSlug = data.getQueryParameter("slug");
                                    } else if (url.startsWith("tg:stars_topup") || url.startsWith("tg://stars_topup")) {
                                        url = url.replace("tg:stars_topup", "tg://indogaro.org").replace("tg://stars_topup", "tg://indogaro.org");
                                        data = Uri.parse(url);
                                        long balance = 0;
                                        try {
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.id.indogaro.messenger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.id.indogaro.messenger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("id.indogaro.messenger.OPEN_ACCOUNT")) {
                    open_settings = 1;
                                        ...
                                        if (error1 != null) {
                                            ...
                                            if ((attachBot.inactive || attachBot.side_menu_disclaimer_needed) && botAttachable) {
                                                WebAppDisclaimerAlert.show(this, (allowSendMessage) -> {
                                                    ...
                                                    processWebAppBot(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, botAppMaybe, botAppStartParam, progress, forceNotInternalForApps, storyId, false, storyAlbumId, giftCollectionId, isBoost, chatLinkSlug, user, dismissLoading, botAttachable, true, botCompact, botFullscreen, openedIndogaro, openProfile, forceRequest, referrer, openDirect);
                                                ...
                                                AlertsCreator.createBotLaunchAlert(getLastFragment(), allowWrite, user, () -> {
                                                    ...
                                                    processWebAppBot(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, botAppMaybe, botAppStartParam, progress, forceNotInternalForApps, storyId, false, storyAlbumId, giftCollectionId, isBoost, chatLinkSlug, user, dismissLoading, false, false, botCompact, botFullscreen, openedIndogaro, openProfile, forceRequest, referrer, openDirect);
                                                });
                                            } else {
                                                processWebAppBot(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, botAppMaybe, botAppStartParam, progress, forceNotInternalForApps, storyId, false, storyAlbumId, giftCollectionId, isBoost, chatLinkSlug, user, dismissLoading, false, false, botCompact, botFullscreen, openedIndogaro, openProfile, forceRequest, referrer, openDirect);
                                            }
...
//                            args.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupAlertText", R.string.AddToTheGroupAlertText, UserObject.getUserName(user), "%1$s"));
    ...
    private void processWebAppBot(
        ...
        ConnectionsManager.getInstance(intentAccount).sendRequest(getBotApp, (response1, error1) -> {
            ...
            if (error1 != null) {
                AndroidUtilities.runOnUIThread(() -> runLinkRequest(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, null, null, progress, forceNotInternalForApps, storyId, liveStory, storyAlbumId, giftCollectionId, null, null, isBoost, chatLinkSlug, botCompact, botFullscreen, openedIndogaro, openProfile, forceRequest, referrer, null, openDirect, null));
            } else {
...
//                        if (AndroidUtilities.isTablet() || true) {
                            ...
                            sheet.setWasOpenedByLinkIntent(openedIndogaro);
        ...
        if (id == NotificationCenter.appDidLogout) {
            ...
            if (reason == 5) {
                ...
                if (type.startsWith("AUTH_KEY_DROP_")) {
                    ...
                    builder.setTitle(LocaleController.getString(R.string.IndogaroPremium));
                    builder.setPositiveButton(LocaleController.getString(R.string.OK), null);
                } else {
                    builder.setPositiveButton(LocaleController.getString(R.string.OK), null);
                }
                ...
                builder.setMessage(LocaleController.getString(R.string.UseProxyIndogaroError));
                builder.setPositiveButton(LocaleController.getString(R.string.OK), null);
