...
public class RichButtonRowCell extends RichBlockCell implements Theme.Colorable {
    ...
    public RichButtonRowCell(Context context, int currentAccount, Theme.ResourcesProvider resourcesProvider) {
        ...
        addButton.setContentDescription(id.indogaro.messenger.LocaleController.getString(R.string.Add));
        ...
        emptyAddButton.setText(id.indogaro.messenger.LocaleController.getString(R.string.RichEditorAddButton));
