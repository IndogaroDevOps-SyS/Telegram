...
public class RichEditText extends EditTextCaption {
    ...
    private int currentAccount = id.indogaro.messenger.UserConfig.selectedAccount;
    ...
    public void addStyle(int flag, int start, int end) {
        ...
        if ((flag & id.indogaro.ui.Components.TextStyleSpan.FLAG_STYLE_SPOILER) != 0) invalidateSpoilers();
        notifySpansChanged();
    }
