...
import id.indogaro.ui.ActionBar.FloatingToolbar;
...
public class RichEditorListView extends UniversalRecyclerView {
    ...
    private MediaUploadState resolveBlockMedia(TL_iv.PageBlock block) {
        if (block instanceof TL_iv.pageBlockAudio) {
            ...
            final TLRPC.PhotoSize big = id.indogaro.messenger.FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.getPhotoSize());
            if (big != null) {
                media.width = big.w;
                media.height = big.h;
            }
    ...
    public class InlineButtonEdit {
        ...
        public void showInputDialog(String title, String hint, String initial, boolean showPaste,
                                    id.indogaro.ui.Components.EditTextCaption.InputDialogCallback callback) {
