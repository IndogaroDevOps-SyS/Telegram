...
import static id.indogaro.tgnet.TLRPC.TL_payments_checkedGiftCode.NO_USER_ID;
import static id.indogaro.ui.Components.Premium.LimitReachedBottomSheet.TYPE_FEATURES;
...
import id.indogaro.ui.Components.LinkActionView;
...
import id.indogaro.ui.Components.Premium.boosts.cells.statistics.GiftedUserCell;
import id.indogaro.ui.Components.Premium.boosts.cells.statistics.GiveawayCell;
import id.indogaro.ui.Components.RecyclerListView;
import id.indogaro.ui.Components.ScrollSlidingTextTabStrip;
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            if (holder.getItemViewType() == BOOST_VIEW || holder.getItemViewType() == HEADER_PADDING || holder.getItemViewType() == BOTTOM_PADDING) {
                ...
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidGiveaway) {
                    String name = LocaleController.formatPluralString("BoostingIndogaroPremiumCountPlural", prepaidGiveaway.quantity);
