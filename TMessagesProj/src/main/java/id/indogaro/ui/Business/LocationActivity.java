...
import id.indogaro.ui.Components.ClipRoundedDrawable;
...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void showLocationAlert() {
        id.indogaro.ui.LocationActivity fragment = new id.indogaro.ui.LocationActivity(ChatAttachAlertLocationLayout.LOCATION_TYPE_BIZ);
        if (geo != null) {
