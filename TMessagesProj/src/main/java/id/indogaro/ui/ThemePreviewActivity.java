...
import id.indogaro.ui.Cells.PatternCell;
import id.indogaro.ui.Components.AlertsCreator;
import id.indogaro.ui.Components.AnimatedFloat;
import id.indogaro.ui.Components.BackgroundGradientDrawable;
import id.indogaro.ui.Components.BackupImageView;
import id.indogaro.ui.Components.CircularProgressDrawable;
import id.indogaro.ui.Components.ColorPicker;
...
import id.indogaro.ui.Components.GestureDetector2;
...
import id.indogaro.ui.Components.WallpaperCheckBoxView;
import id.indogaro.ui.Components.WallpaperParallaxEffect;
import id.indogaro.ui.Stories.recorder.PreviewView;
import id.indogaro.ui.Stories.recorder.SliderView;
...
public class ThemePreviewActivity extends BaseFragment implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    id.indogaro.ui.ActionBar.MessageDrawable msgOutDrawable = new MessageDrawable(id.indogaro.ui.ActionBar.MessageDrawable.TYPE_TEXT, true, false);
    id.indogaro.ui.ActionBar.MessageDrawable msgOutDrawableSelected = new MessageDrawable(id.indogaro.ui.ActionBar.MessageDrawable.TYPE_TEXT, true, true);
    id.indogaro.ui.ActionBar.MessageDrawable msgOutMediaDrawable = new MessageDrawable(id.indogaro.ui.ActionBar.MessageDrawable.TYPE_MEDIA, true, false);
    id.indogaro.ui.ActionBar.MessageDrawable msgOutMediaDrawableSelected = new MessageDrawable(id.indogaro.ui.ActionBar.MessageDrawable.TYPE_MEDIA, true, true);
...
//                        }, 200);
        ...
        if (messagesAdapter.showSecretMessages) {
            actionBar2.setTitle("Indogaro Beta Chat");
...
//                    backgroundImage.setAlpha(0.0f);
        ...
        public MessagesAdapter(Context context) {
            ...
            if (screenType == SCREEN_TYPE_CHANGE_BACKGROUND) {
                ...
                if (index1 != -1 && index2 != -1) {
                    ...
                    entityUrl.url = "https://indogaro.org";
    ...
    private class MessageDrawable extends id.indogaro.ui.ActionBar.MessageDrawable {
