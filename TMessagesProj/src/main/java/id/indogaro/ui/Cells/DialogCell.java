...
import id.indogaro.ui.Components.BubbleCounterPath;
...
import id.indogaro.ui.Components.DialogCellTags;
...
import id.indogaro.ui.Components.StatusDrawable;
...
import id.indogaro.ui.Components.URLSpanNoUnderlineBold;
import id.indogaro.ui.Components.VectorAvatarThumbDrawable;
import id.indogaro.ui.Components.dialogs.DialogMediaIconsHelper;
import id.indogaro.ui.Components.spoilers.SpoilerEffect;
import id.indogaro.ui.DialogsActivity;
import id.indogaro.ui.FilterCreateActivity;
import id.indogaro.ui.RightSlidingDialogContainer;
        ...
        if (message != null && message.messageOwner != null && message.messageOwner.media instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            for (int i = 0; i < Math.min(3, groupMessages.size()); ++i) {
                ...
                if (message != null && !message.needDrawBluredPreview() && (message.isPhoto() || message.isNewGif() || message.isVideo() || message.isRoundVideo() || message.isStoryMedia())) {
                    ...
                    if (!("app".equals(type) || "profile".equals(type) || "article".equals(type) || type != null && type.startsWith("indogaro_"))) {
                        setThumb(i, message);
                    }
                }
            }
