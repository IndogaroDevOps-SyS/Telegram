...
import id.indogaro.ui.Cells.TextCheckBoxCell;
import id.indogaro.ui.Cells.TextInfoPrivacyCell;
import id.indogaro.ui.Cells.TextSettingsCell;
...
import id.indogaro.ui.Components.CacheChart;
...
import id.indogaro.ui.Components.NestedSizeNotifierLayout;
...
import id.indogaro.ui.Components.SlideChooseView;
import id.indogaro.ui.Components.StorageDiagramView;
import id.indogaro.ui.Components.StorageUsageView;
import id.indogaro.ui.Components.TypefaceSpan;
import id.indogaro.ui.Storage.CacheModel;
...
//            loadDialogEntities();
    ...
    class CacheChartHeader extends FrameLayout {
        ...
        public CacheChartHeader(Context context) {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                if (i == 0) {
                    ...
                    subtitle[i].setText(LocaleController.getString(R.string.StorageUsageIndogaro));
        ...
        public void setData(boolean hasCache, float percent, float usedPercent) {
            ...
            if (hasCache) {
                if (percent < 0.01f) {
                    subtitle[1].setText(formatString(R.string.StorageUsageIndogaroLess, formatPercent(percent)));
                } else {
                    subtitle[1].setText(formatString(R.string.StorageUsageIndogaro, formatPercent(percent)));
                }
                switchSubtitle(1);
            } else {
                switchSubtitle(2);
...
//                    } else
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(listView, 0, new Class[]{StorageUsageView.class}, new String[]{"indogaroCacheTextView"}, null, null, null, Theme.key_windowBackgroundWhiteGrayText));
