...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "id.indogaro.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "id.indogaro.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "id.indogaro.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "id.indogaro.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "id.indogaro.android.musicplayer.next";
    public static final String NOTIFY_SEEK = "id.indogaro.android.musicplayer.seek";
    public static final String NOTIFY_REPEAT = "id.indogaro.android.musicplayer.repeat";
    public static final String NOTIFY_SHUFFLE = "id.indogaro.android.musicplayer.shuffle";
