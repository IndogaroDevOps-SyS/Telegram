...
import static id.indogaro.tgnet.TLObject.hasFlag;
import static id.indogaro.tgnet.TLObject.setFlag;
...
import id.indogaro.ui.ArticleViewer;
...
import id.indogaro.ui.Components.ReplyMessageLine;
import id.indogaro.ui.Components.TornEdge;
...
import id.indogaro.ui.Components.UnsupportedBlockDrawable;
...
import id.indogaro.ui.iv.RichTextStyle;
...
public class RichMessageLayout {
    ...
    private id.indogaro.ui.Components.Text showMoreText;
...
//                }
    ...
    private void drawShowMoreButton(Canvas canvas, int contentBottom) {
        ...
        if (showMoreText == null) {
            showMoreText = new id.indogaro.ui.Components.Text(LocaleController.getString(R.string.ShowMore), 16, AndroidUtilities.bold());
        }
