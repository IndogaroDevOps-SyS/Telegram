...
import id.indogaro.tlrpc.SchemeAllLayersParser
import id.indogaro.tlrpc.SchemeCodeGen
import id.indogaro.tlrpc.SchemeTlValidator
import id.indogaro.tlrpc.models.RulesHolder
import id.indogaro.tlrpc.models.TlObjectWithLayer
import id.indogaro.tlrpc.schema.TlSchemaJsonParser
import id.indogaro.tlrpc.telegram.TelegramCodeParser
import id.indogaro.tlrpc.telegram.TelegramTlClass
import java.io.File
...
abstract class GenerateSchemeTask : DefaultTask() {
    ...
    private fun generateSchemeClassForType(
        ...
        val packageName = "id.indogaro.tgnet.model.generated"
        ...
        val sealedClassBuilder = TypeSpec.classBuilder(sealedClassName)
            ...
            .addSuperinterface(ClassName("id.indogaro.tgnet.model", "TlGen_Object"))
        ...
        FileSpec.builder(packageName, sealedClassName)
            .addImport("id.indogaro.tgnet.model", "TlGen_Object", "TlGen_Vector")
    ...
    private fun generateSchemeTestClassForType(
        ...
        val packageName = "id.indogaro.tgnet.test.generated"
        ...
        val testActualBuilder = TypeSpec.classBuilder("Test_Actual")
            .superclass(ClassName("id.indogaro.tgnet.test", "BaseSchemeTest"))
        ...
        for (constructor in constructorsSorted) {
            ...
            val lines = lt[constructor.tl.key.name.type]?.map { clz ->
                ...
                "test_TLdeserialize(id.indogaro.tgnet.model.generated.TlGen_${type}.${constructor.codegenDataClassName}::class, " +
