...
class TestGeneratorPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        val generateSchemeTask = project.tasks.register(
            ...
            tlSourcesDir = File(project.rootDir, "TMessagesProj/src/main/java/id/indogaro/tgnet")
            tlSourcesDirectDir = File(project.rootDir, "TMessagesProj_AppStandalone/src/main/java/id/indogaro/tgnet")
