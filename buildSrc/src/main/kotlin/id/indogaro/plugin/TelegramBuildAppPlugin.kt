...
import id.indogaro.tasks.EmojiPackTask
import id.indogaro.tasks.GenerateStringResourceIdsAssetTask
import id.indogaro.tasks.GenerateLottieMetadataAssetFileTask
import id.indogaro.tasks.TelegramStringsTask
    ...
    override fun apply(project: Project) {
        ...
        val androidComponents =
            project.extensions.findByType(AndroidComponentsExtension::class.java)
                ?: error("Apply com.android.application/library before id.indogaro.build-app-plugin")
