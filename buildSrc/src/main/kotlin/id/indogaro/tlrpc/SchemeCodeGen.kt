...
import id.indogaro.tlrpc.models.TlParam
import id.indogaro.tlrpc.models.TlParamOptionalKey
import id.indogaro.tlrpc.schema.TlSchemaParamType
import id.indogaro.tlrpc.models.TlParams
import id.indogaro.tlrpc.schema.TlSchemaPrimitiveType

object SchemeCodeGen {
    private val CLASS_OUTPUT = ClassName("id.indogaro.tgnet", "OutputSerializedData")
    ...
    fun generateDataClass(tl: TlObjectWithLayer, superclass: TypeName?): TypeSpec {
        ...
        if (superclass == null) {
            builder.addSuperinterface(ClassName("id.indogaro.tgnet.model", "TlGen_Object"))
        }
        ...
        return when (type) {
            ...
            is TlSchemaParamType.Primary.Object -> {
                if (type.name == "Bool") {
                    ...
                    ClassName("id.indogaro.tgnet.model.generated", "TlGen_" + type.name.replace('.', '_'))
                }
            }
            ...
            is TlSchemaParamType.Primary.X -> ClassName("id.indogaro.tgnet.model", "TlGen_Object")
